...
export const metadata = {
  title: 'Investors - RealEstate Assets',
  description: 'Investment strategy, performance metrics, and resources for our investor community.',
};

export default function Investors() {
  const performanceData = [
    { label: 'Average Annual Return', value: '12.5%', change: '+2.3%' },
    { label: 'Portfolio Value', value: '$450M', change: '+15%' },
    { label: 'Properties Under Management', value: '150+', change: '+12' },
    { label: 'Investor Satisfaction', value: '98%', change: '+3%' },
  ];
            ...
            {performanceData.map((item, index) => (
              <Card key={index} className="text-center">
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-green-600 font-semibold">{item.change} YoY</p>
                </CardContent>
              </Card>
            ))}
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              <Card className="bg-slate-900 text-white">
                <CardContent className="p-6">
                  ...
                  <p className="text-slate-300 mb-6">
                    Access your personalized dashboard with real-time portfolio performance, documents, and payment history.
                  </p>
                  <Separator className="my-6 bg-slate-700" />
                  <div className="space-y-4">
                    <div className="flex items-center">
                      <FileText className="mr-3 text-blue-400" size={20} />
                    ...
                    <div className="flex items-center">
                      <Shield className="mr-3 text-blue-400" size={20} />
              ...
              <Card>
                <CardContent className="p-6">
                  <h3 className="text-xl font-bold text-slate-900 mb-4">Download Resources</h3>
                  <div className="space-y-3">
                    ...
                    <Button variant="outline" className="w-full justify-start">
                      <FileText className="mr-2" size={18} />
                      Q4 2024 Performance Report (PDF)
                    </Button>
                    <Button variant="outline" className="w-full justify-start">
                      <FileText className="mr-2" size={18} />
